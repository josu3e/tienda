...
class InstallControllerHttpDatabase extends InstallControllerHttp {
    ...
    public function validate() {
        $this->errors = $this->model_database->testDatabaseSettings(
                $this->session->database_server, $this->session->database_name, $this->session->database_login, $this->session->database_password, $this->session->database_prefix,
    ...
    public function processCheckDb() {
        ...
        $this->ajaxJsonAnswer(
                (count($errors)) ? false : true, (count($errors)) ? implode('<br />', $errors) : $this->l('Database is connected')
        );
    }
    ...
    public function processCreateDb() {
        ...
        $this->ajaxJsonAnswer(
                $success, $success ? $this->l('Database is created') : $this->l('Cannot create the database automatically')
        );
    }
