...
class CartControllerCore extends FrontController {
    ...
    protected function processChangeProductAddressDelivery() {
        ...
        $this->context->cart->setProductAddressDelivery(
                $this->id_product, $this->id_product_attribute, $old_id_address_delivery, $new_id_address_delivery);
    }
    ...
    protected function processDuplicateProduct() {
        ...
        if (!$this->context->cart->duplicateProduct(
                        $this->id_product, $this->id_product_attribute, $this->id_address_delivery, (int) Tools::getValue('new_id_address_delivery')
                )) {
