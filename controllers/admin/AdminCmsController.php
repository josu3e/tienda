...
class AdminCmsControllerCore extends AdminController {
    ...
    public function postProcess() {
        ...
        /* Change object statuts (active, inactive) */ elseif (Tools::isSubmit('statuscms') && Tools::isSubmit($this->identifier)) {
            if ($this->tabAccess['edit'] === '1') {
        ...
        /* Delete multiple CMS content */ elseif (Tools::isSubmit('submitBulkdeletecms')) {
            if ($this->tabAccess['delete'] === '1') {
