...
class Smarty_Internal_Compile_Block extends Smarty_Internal_CompileBase {
    ...
    [$_name]['source'] = "{$compiler-> smarty-> left_delimiter  }private_child_block name={$_attr['name']} file='{$compiler->template->source->filepath}' type='{$compiler->template->source->type}' resource='{$compiler->template->template_resource}'" .
