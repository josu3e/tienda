                ...
                foreach ($images_types as $image_type) {
                    if (file_exists(_PS_PROD_IMG_DIR_ . $image_old->getExistingImgPath() . '-' . $image_type['name'] . '.jpg')) {
                        ...
                        if (Configuration::get('WATERMARK_HASH')) {
                            copy(_PS_PROD_IMG_DIR_ . $image_old->getExistingImgPath() . '-' . $image_type['name'] . '-' . Configuration::get('WATERMARK_HASH') . '.jpg', $new_path . '-' . $image_type['name'] . '-' . Configuration::get('WATERMARK_HASH') . '.jpg');
                        }
                    }
                }
