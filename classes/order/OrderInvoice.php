...
class OrderInvoiceCore extends ObjectModel {
    ...
    public function getSibling() {
        ...
        $query->innerJoin(
                'order_invoice_payment', 'oip2', 'oip2.id_order_payment = oip1.id_order_payment AND oip2.id_order_invoice <> oip1.id_order_invoice'
        );
    ...
    public function getSiblingTotal($mod = OrderInvoice::TAX_INCL) {
        ...
        $query->leftJoin(
                'order_invoice', 'oi', 'oi.id_order_invoice = oip2.id_order_invoice'
        );
        $query->where('oip1.id_order_invoice = ' . $this->id);
