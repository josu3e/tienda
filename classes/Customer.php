...
class CustomerCore extends ObjectModel {
    ...
    public function transformToCustomer($id_lang, $password = null) {
        ...
        if ($this->update()) {
            ...
            Mail::Send(
                    (int) $id_lang, 'guest_to_customer', Mail::l('Your guest account has been transformed into a customer account', (int) $id_lang), $vars, $this->email, $this->firstname . ' ' . $this->lastname, null, null, null, null, _PS_MAIL_DIR_, false, (int) $this->id_shop
            );
            return true;
        }
        return false;
