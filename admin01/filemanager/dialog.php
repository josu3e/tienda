                        ...
                        <?php if (@opendir($current_path . $subfolder . $subdir) === false) {
                            ...
                            ?>">
                                    ...
                                    foreach ($files as $file_array) {
                                        ...
                                        ?>
                                    <li data-name="<?php echo Tools::safeOutput($file) ?>" <?php
                                    if ($file == '..') {
                                        echo 'class="back"';
                                    } else {
                                        echo 'class="dir"';
                                    ...
                                    ?>>
                                        <figure data-name="<?php echo Tools::safeOutput($file) ?>" class="<?php
                                        if ($file == "..") {
                                            echo "back-";
                                        }
                                        ?>directory" data-type="<?php
                                            ...
                                            <a class="folder-link" href="dialog.php?<?php echo $get_params . rawurlencode($src) . "&" . uniqid() ?>">
                                                ...
                                                ?></div>
                                                <figcaption>
                                                    <a href="javascript:void('')" class="tip-left edit-button <?php
                                                    if ($rename_folders) {
                                                        echo "rename-folder";
                                                    }
                                ...
                                foreach ($files as $nu => $file_array) {
                                    ...
                                    if ((!(Tools::getValue('type') == 1 && !$is_img) && !((Tools::getValue('type') == 3 && !$is_video) && (Tools::getValue('type') == 3 && !$is_audio))) && $class_ext > 0) {
                                        ...
                                        ?>">
                                            <figure data-name="<?php echo Tools::safeOutput($file) ?>" data-type="<?php
                                            if ($is_img) {
                                                echo "img";
                                            } else {
                                                echo "file";
                                            ...
                                            ?>">
                                                    ...
                                                    ?>">
                                                        <div class="filetype <?php echo $extension_lower ?> <?php
                                                        if (!$is_icon_thumb) {
                                                            echo "hide";
                                                        }
