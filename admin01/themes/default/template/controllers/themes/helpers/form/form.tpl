                ...
                <div class="panel">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 addons-see-all-themes">
                            {l s='Or'}<a href="http://addons.prestashop.com/{$iso_code}/3-templates-prestashop" class="btn btn-primary" onclick="return !window.open(this.href)
                                    p">{l s='See all themes'}</a>
                        </div>
                    </div>
                </div>
