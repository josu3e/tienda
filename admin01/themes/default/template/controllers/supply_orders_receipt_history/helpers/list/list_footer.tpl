...
{block name="footer"}
    <div class="panel-footer">
        ...
        {/if}
        <a href="" class="btn btn-default pull-right" onclick="if (confirm('{l s='Update selected items?'}'))
                    sendBulkAction($(this).closest('form').get(0), 'submitBulkUpdatesupply_order_detail');
                return false;">
