...
for (i in restrictions)
{
    ...
    $('#' + restrictions[i] + '_restriction').click(function () {
        toggleCartRuleFilter(this);
    });
    $('#' + restrictions[i] + '_select_remove').click(function () {
        removeCartRuleOption(this);
    });
    $('#' + restrictions[i] + '_select_add').click(function () {
    ...
    if ($('#cart_rule_select_1').length > 0 && $('#cart_rule_select_2').length > 0) {
        ...
        $('.uncombinable_search_filter').typeWatch({
            ...
            callback: function (text) {
                combinable_filter('#cart_rule_select_1', text, 'unselected');
            }
        });
        ...
        $('.combinable_search_filter').typeWatch({
            ...
            wait: 500,
            callback: function (text) {
                combinable_filter('#cart_rule_select_2', text, 'selected');
            }
        });
    }
});
