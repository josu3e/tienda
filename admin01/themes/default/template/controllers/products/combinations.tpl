...
{if isset($product->id) && !$product->is_virtual}
    <div id="product-combinations" class="panel product-tab">
        ...
        <div id="add_new_combination" class="panel" style="display: none;">
            ...
            <div class="form-group">
                ...
                <input type="text" name="attribute_wholesale_price" id="attribute_wholesale_price" value="0" onKeyUp="if (isArrowKey(event))
                            return;
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <div class="row">
                <div class="col-lg-4">
                    <select name="attribute_price_impact" id="attribute_price_impact" onchange="check_impact();
                            calcImpactPriceTI();">
                ...
                <div id="span_impact" class="col-lg-8">
                    <div class="form-group">
                        ...
                        <input type="text" id="attribute_price" value="0.00" onkeyup="$('#attribute_priceTEReal').val(this.value.replace(/,/g, '.'));
                                if (isArrowKey(event))
                                    return;
                                this.value = this.value.replace(/,/g, '.');
                                calcImpactPriceTI();"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="attribute_priceTI" id="attribute_priceTI" value="0.00" onkeyup="if (isArrowKey(event))
                                return;
                            this.value = this.value.replace(/,/g, '.');
                            calcImpactPriceTE();"/>
                </div>
            ...
            <div id="span_weight_impact" class="col-lg-8">
                <div class="row">
                    ...
                    <div class="input-group col-lg-5">
                        ...
                        <input type="text" name="attribute_weight" id="attribute_weight" value="0.00" onKeyUp="if (isArrowKey(event))
                                    return;
                                this.value = this.value.replace(/,/g, '.');" />
                    </div>
                </div>
...
<div id="tr_unit_impact" class="form-group">
    ...
    <div class="col-lg-6">
        ...
        <input type="text" name="attribute_unity" id="attribute_unity" value="0.00" onKeyUp="if (isArrowKey(event))
                    return;
                this.value = this.value.replace(/,/g, '.');" />
    </div>
</div>
...
{if $ps_use_ecotax}
    <div class="form-group">
        ...
        <input type="text" name="attribute_ecotax" id="attribute_ecotax" value="0.00" onKeyUp="if (isArrowKey(event))
                    return;
                this.value = this.value.replace(/,/g, '.');" />
    </div>
</div>
