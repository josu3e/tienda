        ...
        <fieldset>
            <div class="box">
                ...
                <div id="opc_account_form" class="unvisible">
                    ...
                    {/if}
                    <div id="hidden_address" style="">
                        {$stateExist = false}
                        {$postCodeExist = false}
                        {$dniExist = false}
                        {foreach from=$dlv_all_fields item=field_name}
                            {if $field_name eq "company"}
                                <input type="hidden" class="text form-control validate" id="company" name="company" data-validate="isGenericName" value="{if isset($guestInformations) && isset($guestInformations.company) && $guestInformations.company}{$guestInformations.company}{/if}" />
                            {elseif $field_name eq "vat_number"}
                                <input type="hidden" class="text form-control" name="vat_number" id="vat_number" value="{if isset($guestInformations) && isset($guestInformations.vat_number) && $guestInformations.vat_number}{$guestInformations.vat_number}{/if}" />
                            {elseif $field_name eq "dni"}
                                {assign var='dniExist' value=true}
                                <input type="hidden" class="text form-control validate" name="dni" id="dni" data-validate="isDniLite" value="{if isset($guestInformations) && isset($guestInformations.dni) && $guestInformations.dni}{$guestInformations.dni}{/if}" />
                            ...
                            {elseif $field_name eq "address1"}
                                <input type="hidden" class="text form-control validate" name="address1" id="address1" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address1) && isset($guestInformations) && isset($guestInformations.address1) && $guestInformations.address1}{$guestInformations.address1}{else}{l s='My addres 1'}{/if}" />
                            {elseif $field_name eq "address2"}
                                <input type="hidden" class="text form-control validate" name="address2" id="address2" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address2) && isset($guestInformations) && isset($guestInformations.address2) && $guestInformations.address2}{$guestInformations.address2}{else}{l s='My addres 2'}{/if}" />
                            {elseif $field_name eq "postcode"}
                                {$postCodeExist = true}
                                <input type="hidden" class="text form-control validate" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode) && $guestInformations.postcode}{$guestInformations.postcode}{else}000{/if}"/>
                            {elseif $field_name eq "city"}
                                <input type="hidden" class="text form-control validate" name="city" id="city" data-validate="isCityName" value="{if isset($guestInformations) && isset($guestInformations.city) && $guestInformations.city}{$guestInformations.city}{/if}" />
                            {elseif $field_name eq "country" || $field_name eq "Country:name"}
                                {foreach from=$countries item=v}
                                    <input type="hidden" class="text form-control validate" name="id_country" id="id_country" value="{if (isset($guestInformations) && isset($guestInformations.id_country) && $guestInformations.id_country == $v.id_country) || (!isset($guestInformations) && $sl_country == $v.id_country)}{$v.id_country}{else}171{/if}" />
                                {/foreach}
                            {elseif $field_name eq "state" || $field_name eq 'State:name'}
                                {$stateExist = true}
                                <input type="hidden" name="id_state" id="id_state" value=""/>
                            {/if}
                        {/foreach}
                        {if !$postCodeExist}
                            <input type="hidden" class="text form-control validate" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode) && $guestInformations.postcode}{$guestInformations.postcode}{else}000{/if}"/>
                        ...
                        <input type="hidden" class="text form-control validate" name="phone_mobile" id="phone_mobile" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone_mobile) && $guestInformations.phone_mobile}{$guestInformations.phone_mobile}{/if}" />
                        ...
                        <input type="hidden" name="invoice_address" id="invoice_address" value="{if (isset($smarty.post.invoice_address) && $smarty.post.invoice_address) || (isset($guestInformations) && isset($guestInformations.invoice_address) && $guestInformations.invoice_address)}1{/if}" autocomplete="off"/>
                        ...
                        {foreach from=$dlv_all_fields item=field_name}
                            ...
                            {elseif $field_name eq "postcode"}
                                ...
                                <div class="required postcode text form-group">
                                    ...
                                    <input type="text" class="text form-control validate" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode) && $guestInformations.postcode}{$guestInformations.postcode}{else}000{/if}"/>
                                </div>
                            {elseif $field_name eq "city"}
                                <div class="required text form-group">
